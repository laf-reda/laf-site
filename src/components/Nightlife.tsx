  ...
  return (
    <section id="nightlife" className="section section--alt">
      <div className="container">
        <div
          className="nightlife__header"
          ref={headerRef as React.RefObject<HTMLDivElement>}
        >
          <p className={`eyebrow reveal${headerInView ? ' in-view' : ''}`}>After Dark</p>
          ...
          <p className={`section-subtitle reveal reveal-delay-2${headerInView ? ' in-view' : ''}`}>
            Access to the most exclusive venues and experiences on the planet — arranged
            with Reda's personal network and deep industry relationships.
          </p>
        </div>

        <div
          className="nightlife__grid"
